...
public class CPU extends MOS6510Core {
	...
	protected void installROMS() {
		loadROM(loader.getFileStream("roms\\kernal.c64"), KERNAL_ROM2, 0x2000);
		loadROM(loader.getFileStream("roms\\basic.c64"), BASIC_ROM2, 0x2000);
		loadROM(loader.getFileStream("roms\\chargen.c64"), CHAR_ROM2, 0x1000);
	}
	 ...
	 *
	 * @param startAdress an <code>int</code> value that represent the starting
